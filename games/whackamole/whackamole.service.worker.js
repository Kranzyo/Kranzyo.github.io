...
/** @type {string} */
const CACHE_VERSION = '1722717226|234744701';
/** @type {string} */
const CACHE_PREFIX = 'WhackAMole?-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'whackamole.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["whackamole.html","whackamole.js","whackamole.offline.html","whackamole.icon.png","whackamole.apple-touch-icon.png","whackamole.worker.js","whackamole.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["whackamole.wasm","whackamole.pck"];
